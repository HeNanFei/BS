...
<article>
    ...
    <div class="sidebar">
        <div class="about">
            ...
            <p class="abname">被子怪 | 锦添</p>
            <p class="abposition">屌丝三本学生</p>
            <div class="abtext"> 小二货 </div>
        </div>
        <div class="search">
...
<div id="pagination" class="pn"></div>
        ...
        function innerH(msg) {
            ...
            $.each(arr,function (i,item) {
                ...
                $("#articleArea").append(" <li> <span class=\"blogpic\"><a href=\"/\"><img src=\""+item.imgurl+"\"></a></span>\n" +
                    ...
                    "                <p>"+item.content2+"...</p>\n" +
                    "            </div>\n" +
                    "            <div class=\"autor\"><span class=\"lm\"><a href=\"/\" title=\"CSS3|Html5\" target=\"_blank\" class=\"classname\">CSS3|Html5</a></span><span class=\"dtime\">"+item.writed+"</span><span class=\"viewnum\">浏览（<a href=\"/\">"+item.click+"</a>）</span><span class=\"readmore\"><a href=\"/\">阅读原文</a></span></div>\n" +
                    "        </li>\n");
            })
